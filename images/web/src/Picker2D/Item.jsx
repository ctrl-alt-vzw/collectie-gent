  ...
  return( 
    <div className="item">
      ...
      <div className="actions">
        <button id="shuffle" onClick={(e) => props.handleNeighbourSelection(props.data)}>More like this</button>
        <button id="select" onClick={(e) => props.handleCutSelection(props.data)}>Select</button>
      </div>
    </div>
  )
}
