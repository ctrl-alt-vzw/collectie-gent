...
const FILESTORE_URL = "https://media.collage.gent";
...
module.exports = class Cut {
  ...
  renderHTML() {
    ...
    document.getElementById("headerContainer").innerHTML = `
      <button class="secundary" id="backBtn">Terug</button>
      <button class="primary" id="saveBtn">Klaar!</button>
      <button class="secundary" id="restartBtn">Opnieuw</button>`;
  }
  cleanup() {
    const canvas = document.getElementById("cutCanvas");
    ...
    canvas.parentNode.removeChild(document.getElementById("normal_canvas"))
    canvas.parentNode.removeChild(document.getElementById("hiddenCanvasContainer"))
